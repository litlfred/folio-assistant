...
{: .note }
> Generated from [`skills/folio-paper-adapter/compute-audit.md`](https://github.com/litlfred/folio-assistant/blob/main/skills/folio-paper-adapter/compute-audit.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/skills/folio-paper-adapter/compute-audit.md){: .fa-edit-source }
