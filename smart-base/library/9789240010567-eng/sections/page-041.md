...
programme area.
	+ Link bottlenecks to standardized health system challenges to determine actionable 
...
health programme processes (Output 3.4)
	+ Prioritized bottlenecks (Output 3.2) mapped to list of health system challenges to be 
