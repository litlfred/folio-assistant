...
When identifying how best to apply the WHO guideline: 
...
digital health policy (38)
	» WHO Global Observatory for eHealth directory of 
eHealth policies (39).
When transitioning from a siloed digital health system 
architecture to an exchanged digital health system 
architecture (see Fig. 1.3.1). This includes ensuring that the 
...
interoperability. 
When validating the need for a digital health investment 
in response to a funding request. This is a common 
