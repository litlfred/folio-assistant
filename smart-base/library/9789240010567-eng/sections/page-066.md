...
1.	
What do members of the planning team 
(stakeholders) expect the digital health 
interventions to do for them?
2.	
What do end-users expect the digital health 
interventions to do for them?
3.	
What do beneficiaries expect the digital health 
interventions to do for them?
...
End-users
Beneficiaries
The planning team includes stakeholders who are 
responsible for guiding the development of the 
digital health system 
End-users are health workers who interact 
directly with the digital health implementation 
once implemented. Clients, or patients, could also 
be users if they engage directly with the digital 
health system
Beneficiaries are clients or members of the 
