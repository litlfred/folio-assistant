...
Fig. 3.1. 	
Adaptation of CRDM approach for defining health system challenges.
...
2.	
Map the user journey (illustrated through a workflow) within each of these processes.
3.	
Identify bottlenecks within each workflow.
Think
How do we do 
our work now?
	+ Define goals and 
...
support the selected digital 
health interventions.
	+ Define what the digital 
health interventions should 
