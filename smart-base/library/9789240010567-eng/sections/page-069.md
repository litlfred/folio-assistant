...
Gather client 
details
Bottleneck where digital health 
intervention would add value
Gather client 
details
Search  
for client
...
Clerk now only requires a 
few minutes to find the 
client’s records.
No unique identification 
system - Clerk takes hours 
to find the client’s records 
