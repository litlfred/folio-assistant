...
As a 
community nurse
I need a list of my clients whose 
antenatal visits are due today
So that I can plan my day accordingly, including adequate 
supplies to conduct antenatal care checkups.
As a 
community nurse
I need to look up a client’s past 
health record
So I can evaluate whether the client is in a high-risk 
category and needs additional advice.
As a 
community nurse
I need to be able to send my client 
an SMS reminder
So that she can remember to come to the clinic for a 
follow-up ultrasound in the third trimester.
...
4.3.2 	
UNDERSTAND AND MANAGE EXPECTATIONS FROM 
...
the intervention is intended to improve
	» other stakeholders, those with a keen interest in 
the success of the digital health implementation 
