...
Establish training programmes for each cadre of 
health worker and for healthcare managers who are 
involved with the digital implementation. Intensive 
...
actually used. 
Consider demonstrating how the data health workers 
collect will be used in the health programmes they 
implement. Recognize that many health workers and 
