...
HEALTH 
INTERVENTION
The delivery of healthcare services where clients/patients and health workers are separated by 
distance23
COMMONLY 
ASSOCIATED 
HEALTH SYSTEM 
...
BEFORE 
DEPLOYING
	» Determine the mechanisms for outreach and raising awareness about this intervention, such as 
through mass media communication, community outreach and so on.
	» Clarify clinical protocols to explain what can and cannot be done in the remote consultation. For 
...
DURING 
DEPLOYMENT
	» Ensure that use of the technology does not negatively affect the relationship between the 
patient and health worker, particularly when end-users are learning about the technology and 
