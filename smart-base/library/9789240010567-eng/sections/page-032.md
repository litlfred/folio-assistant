...
Planning, Policy and Information (DPPI), hereby declare:
	» Sierra Leone will develop a unified national 
architecture for our health information systems;
	» That will improve the availability, appropriate access 
and use of quality health information across all levels 
of the health system;
	» We will increase access to and use of health 
information technology to improve service delivery 
and demand for services to improve health outcomes;
	» This process will be led, championed and sustained by 
the DPPI for the benefit of all;
