...
architecture composed of stand-alone 
application(s). A digital health project is a time-
bound implementation of a siloed digital health 
enterprise, usually to demonstrate proof of 
concept. 
	» MUD (Monolithic Unarchitected Software 
Distributions): Haphazardly structured, sprawling 
MUD systems are characterized by an evolving 
...
architecture in which two or more applications are 
directly connected to one another (that is, without 
an intermediary data exchange), intended to 
address one or more health system challenges and 
fulfil health programme goals.
