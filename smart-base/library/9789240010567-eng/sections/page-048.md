...
3.1.3 	
IDENTIFY AND CONFIRM BOTTLENECKS 
...
identifying the following:
	...
	» efficiencies that can be gained with repeatable 
tasks
	» redundancy in tasks, such as information collected 
more than once 
	» blocks to the optimal flow from one task to the 
next.
...
process.
1.	
PHYSICAL: tangible, material items failed in 
some way.
2.	
HUMAN: people did something wrong or did 
not do something required.
3.	
ORGANIZATIONAL: a system, process or policy 
