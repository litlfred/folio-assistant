...
would entail, consider the following questions.
	» What are the core components for this digital 
health implementation?
	» Of those core components, which existing 
common components can be reused or leveraged 
from other health programme areas? For example, 
an analytics engine may be a required component 
that another programme area has already 
implemented and can be reused and shared (for 
example, as a shared service).
	» What common components are new requirements 
that the digital health investment can support and 
contribute to the national digital health enterprise 
architecture?
