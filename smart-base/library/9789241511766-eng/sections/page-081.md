...
Output
Case study
In-depth study of a case, where a case may be an 
individual, an event, a group or an institution 
In-depth description of case
Grounded theory
Collected data are used to theorize about how groups 
work or solve problems
Theory, supported by data
Phenomenology
Description of lived experiences of those who have 
experienced the phenomenon of interest
Findings described from subject’s 
point of view
Ethnography
Close field observation (typically of a community) to 
