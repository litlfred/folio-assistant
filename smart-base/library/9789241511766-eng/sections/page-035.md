...
4.	
Review the intermediate results to confirm the logic and ensure that their achievement will lead to the next 
higher-level objective.
5.	
Identify critical assumptions.
6.	
Identify preliminary performance measures, drawing from baseline data, which specify measurable and 
