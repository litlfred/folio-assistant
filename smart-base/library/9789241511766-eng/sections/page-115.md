...
---
105
Step 3: Assessment of data management protocols and data quality
...
a.	
Are the data element names clearly defined in the questionnaire/form?
	
b.	
Have these data elements been previously tested?
	
c.	
Are appropriate parameters (range, format) and validation checks defined for 
the data elements?
	
d.	
Is it possible to incorporate international standard definitions of the data 
...
a.	
Have the staff been trained in data collection using paper forms?
	
b.	
Is there an identifier to link the paper data to the digital data?
	
c.	
Are random checks and other quality control mechanisms in place to assess 
...
a.	
Calculate each of the indicators identified under Step 1.ii? 
	
b.	
Data summary (aggregated data) at community/district/other unit level?
