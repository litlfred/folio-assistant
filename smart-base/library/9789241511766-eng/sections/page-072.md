...
supervisory staff, and issues that arise can be solved on a case-by-case or one-on-one basis. Once the number of users 
...
b.	
Intervention – Content will likely be created and tested during early-stage interventions (pilot-testing and small-scale 
...
a.	
Digital health user interactions as primary versus secondary: In this example there are two types of users 
...
b.	
Identifying the stage of maturity: Recognizing the stage of maturity will allow the project manager to 
...
c.	
Monitoring burden: Here, burden refers to the amount of effort and resources required to successfully monitor 
