...
1.	
Collaborate through partnerships (e.g. with MNOs) to share the costs of scaling up 
nationwide activities.
2.	
Sustain the service completely on their own, without sharing costs with partners.
3.	
Use a so-called freemium model, in which standard features of the hotline service would 
be free of charge while users pay for additional features. 
4.	
Develop a toolkit that would enable partners (government, CBOs and NGOs) to take on 
