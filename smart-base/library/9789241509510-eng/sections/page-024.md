...
---
14
1-2. Has the endgame for scaling up and sustaining the mHealth product been determined? (2 points)
NO
YES
POINTS EARNED
...
practice) or eHealth/mHealth national-level meetings
0
2
...
operational requirements for the mHealth product and deployments
0
2
ii) We have assessed the reliability of network coverage, and can articulate it in terms of 
which networks offer needed coverage for which users
0
2
...
online requirements of the users and the server(s)
0
2
