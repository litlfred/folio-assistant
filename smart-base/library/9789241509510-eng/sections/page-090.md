...
---
80
16-2b. For each of the outcomes specified in 16-2a, have the key components of the evaluation process been 
defined? (12 points)
NO
IN PROGRESS
PERFORMED
...
demonstrated (Does the technology work as intended?) 
0
1
2
3
ii) The usability of the product has been demonstrated (Can 
the product be used effectively by intended users?)
0
1
2
3
...
briefings) have been identified
0
1
2
3
ii) Opportunities for wider dissemination have been 
identified (e.g. publications, poster sessions, websites)
0
1
2
3
