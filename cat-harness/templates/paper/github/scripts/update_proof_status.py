...
Usage:
    FOLIO_PAPER=<paper> python .github/scripts/update_proof_status.py \\
...
from folio_lean.config import CONTENT_ROOT, DEFAULT_MANIFEST, LEAN_DIR
from folio_lean.manifest import load_manifest, save_manifest, update_manifest_timestamp


# The folio's content root and this paper's Lake package, from the
# environment the Lean workflows set (see folio_lean/config.py).
