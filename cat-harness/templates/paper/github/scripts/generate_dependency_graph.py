...
Usage:
    python .github/scripts/generate_dependency_graph.py \\
        ...
        [--output build/<paper>/dependency-graph.svg] \\
        [--pdf-base-url https://<owner>.github.io/<repo>/<paper>.pdf]

Chapter cluster titles are read from the chapters build.ts wrote; the PDF
URL defaults to this repository's GitHub Pages site (folio_lean/config.py).
"""
...
DEFAULT_OUTPUT = BUILD_DIR / "dependency-graph.svg"
