...
const XML = readFileSync(join(ROOT, "workflow-methodologies/crdm/workflows/crdm-requirements.bpmn"), "utf-8");
/**
 ...
 */
const PHASE_XML = readFileSync(join(ROOT, "workflow-methodologies/crdm/workflows/crdm-deliver.bpmn"), "utf-8");

describe("extractBpmn", () => {
  test("finds the labels a reader sees", () => {
    const entries = extractBpmn(XML, "workflow-methodologies/crdm/workflows/crdm-requirements.bpmn");
