...
description: >
  ...
  command that performs all of it, why running that command once is not enough,
  and the two orphan directions it reports rather than fixes. Read this before
