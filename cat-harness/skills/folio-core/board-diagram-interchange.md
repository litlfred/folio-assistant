---
name: board-diagram-interchange
description: >
  A board is a DIAGRAM OF a folio, not a container of one. The OMG split
  between the semantic model and its layout, why the arrow runs one way, and
