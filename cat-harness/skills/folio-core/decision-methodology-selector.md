---
name: decision-methodology-selector
description: >
  Given a decision context, select the applicable methodology from the
  methodology graph. Reads the graph's applies-when declarations, matches
