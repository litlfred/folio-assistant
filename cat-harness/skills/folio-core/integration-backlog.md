...
description: >
  ...
  canonical, compute, detangler, one-voice, …) by clustering the
  open findings into review-sized batches (≤ 49 files per PR — the
  ...
  AskUserQuestion if architectural), then merging — and repeating
