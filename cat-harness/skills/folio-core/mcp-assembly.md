...
name: mcp-assembly
description: >
  Compose several Tool nodes into one MCP service — naming, collisions,
  grouping and versioning. Read when a service will expose more than one tool,
  or when two instances' tools land in the same namespace.
---
