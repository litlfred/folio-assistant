...
export const KG_CRITERIA: readonly KgCriterionDefinition[] = [
  ...
  },
  {
    ...
    severity: "minor",
    summary:
      "A declared prose ↔ code pair — a diagram's <cat-harness.processes:implements workflow>, or a skill .md beside its same-stem .ts — " +
  ...
  },
  {
    ...
    summary:
      ...
      "`<cat-harness.processes:job>` the workflow does not have. `unknown` when every parsed claim pointed outside this repository.",
  },
  {
