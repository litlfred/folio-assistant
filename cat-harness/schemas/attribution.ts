 ...
 * block carrying it.
 *
 * Today the corpus holds one kind and 424 blocks of it, all extracted. That is
 * a determined classification of everything present, NOT an empty registry: an
 * empty one would let the gate pass having checked nothing, which is the
 * "unknown rendered as a pass" failure this repository keeps paying for.
 */
