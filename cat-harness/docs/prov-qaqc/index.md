...
5 instance(s), 61 step(s) checked, 61 `prov:Activity` emitted, 135 finding(s). Policies evaluated: `https://litlfred.github.io/folio-assistant/policies/folio-defaults`, `https://litlfred.github.io/folio-assistant/policies/http-gateway`.
...
| `undeclared-actor` | 61 | the actor is not declared in `.claude/skills/actors/` |
...
8 step(s) checked, 8 `prov:Activity` emitted, 16 finding(s). Source: `cat-harness/processes/code-change-review.bpmn`. [PROV JSON-LD]({{ '/assets/prov/code-change-review--consolidation-956.prov.jsonld' | relative_url }})

| instance | entry | node | finding | detail |
|---|---|---|---|---|
| `code-change-review--consolidation-956` | 1 | `Task_ClaimBean` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--consolidation-956` | 2 | `Task_BranchAndAnnounce` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--consolidation-956` | 3 | `Task_RunGates` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--consolidation-956` | 4 | `Task_Diagnose` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--consolidation-956` | 5 | `Task_Implement` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--consolidation-956` | 6 | `Task_Review` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--consolidation-956` | 8 | `Task_PrepareMerge` | `undeclared-actor` | "claude" is not a declared actor |
...
9 step(s) checked, 9 `prov:Activity` emitted, 18 finding(s). Source: `cat-harness/processes/code-change-review.bpmn`. [PROV JSON-LD]({{ '/assets/prov/code-change-review--issue-1015-prefix-is-stub.prov.jsonld' | relative_url }})

| instance | entry | node | finding | detail |
|---|---|---|---|---|
| `code-change-review--issue-1015-prefix-is-stub` | 1 | `Task_ClaimBean` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--issue-1015-prefix-is-stub` | 2 | `Task_BranchAndAnnounce` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--issue-1015-prefix-is-stub` | 3 | `Task_Implement` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--issue-1015-prefix-is-stub` | 4 | `Task_RunGates` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--issue-1015-prefix-is-stub` | 5 | `Task_CommitAndOpenPR` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--issue-1015-prefix-is-stub` | 6 | `Task_Diagnose` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--issue-1015-prefix-is-stub` | 7 | `Task_RunGates` | `undeclared-actor` | "claude" is not a declared actor |
...
| `code-change-review--issue-1015-prefix-is-stub` | 8 | `Task_PrepareMerge` | `undeclared-actor` | "claude" is not a declared actor |
...
6 step(s) checked, 6 `prov:Activity` emitted, 12 finding(s). Source: `cat-harness/processes/code-change-review.bpmn`. [PROV JSON-LD]({{ '/assets/prov/code-change-review--issue-1190-bean-restates-skill.prov.jsonld' | relative_url }})
...
| `code-change-review--issue-1190-bean-restates-skill` | 5 | `Task_AddressReview` | `undeclared-actor` | "claude" is not a declared actor |
...
28 step(s) checked, 28 `prov:Activity` emitted, 66 finding(s). Sources: `cat-harness/methodologies/crdm/processes/crdm-requirements.bpmn`, `cat-harness/methodologies/crdm/processes/crdm-data-model.bpmn`, `cat-harness/methodologies/crdm/processes/crdm-issue-linking.bpmn`, `cat-harness/methodologies/crdm/processes/crdm-needs.bpmn`, `cat-harness/methodologies/crdm/processes/crdm-requirements-definition.bpmn`, `cat-harness/methodologies/crdm/processes/crdm-signoff.bpmn`. [PROV JSON-LD]({{ '/assets/prov/crdm--folio-assistant-6lb8.prov.jsonld' | relative_url }})
...
| `crdm--folio-assistant-6lb8` | 1 | `BA_Submit` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8` | 2 | `A_Detect` | `undeclared-actor` | "claude" is not a declared actor |
| `crdm--folio-assistant-6lb8` | 2 | `A_Detect` | `unknown` | no policy grants perform-task for Process_CRDM/A_Detect as authoring-agent |
| `crdm--folio-assistant-6lb8` | 3 | `GW_Feature` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8` | 4 | `Call_Issue` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8` | 5 | `Call_Needs` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8` | 6 | `Call_Requirements` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8` | 7 | `Call_DataModel` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_DataModel` | 1 | `A_Entities` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_DataModel` | 2 | `A_Relations` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_DataModel` | 6 | `A_Declare` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Issue` | 1 | `A_ScanIssues` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Issue` | 2 | `GW_Issue` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Issue` | 3 | `A_AskCreate` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Needs` | 1 | `A_Stakeholders` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Needs` | 2 | `A_Synthesise` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Needs` | 5 | `GW_Needs` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Requirements` | 1 | `A_MapWorkflow` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Requirements` | 2 | `A_DefineReqs` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Requirements` | 3 | `A_CompareOptions` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Requirements` | 6 | `GW_Reqs` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--folio-assistant-6lb8/Call_Signoff` | 1 | `A_CreateBeans` | `undeclared-actor` | "claude" is not a declared actor |
...
10 step(s) checked, 10 `prov:Activity` emitted, 23 finding(s). Sources: `cat-harness/methodologies/crdm/processes/crdm-requirements.bpmn`, `cat-harness/methodologies/crdm/processes/crdm-issue-linking.bpmn`, `cat-harness/methodologies/crdm/processes/crdm-needs.bpmn`. [PROV JSON-LD]({{ '/assets/prov/crdm--issue-607-kg-to-cdn-portal.prov.jsonld' | relative_url }})
...
| `crdm--issue-607-kg-to-cdn-portal` | 2 | `A_Detect` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--issue-607-kg-to-cdn-portal` | 3 | `GW_Feature` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--issue-607-kg-to-cdn-portal` | 4 | `Call_Issue` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--issue-607-kg-to-cdn-portal/Call_Issue` | 1 | `A_ScanIssues` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--issue-607-kg-to-cdn-portal/Call_Issue` | 2 | `GW_Issue` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--issue-607-kg-to-cdn-portal/Call_Issue` | 3 | `A_LinkIssue` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--issue-607-kg-to-cdn-portal/Call_Needs` | 1 | `A_Stakeholders` | `undeclared-actor` | "claude" is not a declared actor |
...
| `crdm--issue-607-kg-to-cdn-portal/Call_Needs` | 2 | `A_Synthesise` | `undeclared-actor` | "claude" is not a declared actor |
