...
[Open the BPMN source](https://github.com/litlfred/folio-assistant/blob/main/workflow-methodologies/crdm/workflows/crdm-requirements.bpmn){: .btn .btn-outline }
...
`workflow-methodologies/crdm/workflows/crdm-requirements.bpmn` is a loadable BPMN process like every
