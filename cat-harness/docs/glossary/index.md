...
Every term the instances in this repository define or carry, as W3C SKOS. Terms link to the external concepts they match rather than copying them. 2458 terms: **7 authored** in 2 glossaries, on this page, and **2451 extracted** from knowledge-graph assets in 18 generated schemes, one page per asset type, plus the sources below.
...
<tr><td><a href="{{ '/glossary/schema-fields/' | relative_url }}">Schema fields</a></td><td>candidates, extracted</td><td>1543</td><td>834 KB</td></tr>
</tbody></table></div>
