...
{: .note }
> Generated from [`theming/overview.md`](https://github.com/litlfred/folio-assistant/blob/main/theming/overview.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/theming/overview.md){: .fa-edit-source }
...
|---|---|---|---|
| 1 | [`theme-art-intake`](intake.md) | **producer** | art arrives; accepted with its declaration written, or refused with a named reason |
| 2 | [`theme-declaration`](declaration.md) | **producer** | what a theme IS as data — palette, three layouts, `textRegion`, `avatarRegion` |
| 3 | [`theme-generation`](generation.md) | **consumer** | `themes.css`, and the fallback that paints over its own art |
| 4 | [`theme-contrast`](contrast.md) | **consumer** | scrims, WCAG, and why the measurement is over pure black |
| — | [`theme-artefacts`](artefacts.md) | specialisation | sticky, landing board, docs background, navbar avatar — only what DIFFERS |
