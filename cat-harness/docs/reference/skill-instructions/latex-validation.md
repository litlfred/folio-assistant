...
{: .note }
> Generated from [`cat-harness/skills/folio-paper-adapter/latex-validation.md`](https://github.com/litlfred/folio-assistant/blob/main/cat-harness/skills/folio-paper-adapter/latex-validation.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/cat-harness/skills/folio-paper-adapter/latex-validation.md){: .fa-edit-source }
