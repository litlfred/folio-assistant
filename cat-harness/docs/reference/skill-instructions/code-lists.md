...
{: .note }
> Generated from [`skills/folio-core/code-lists.md`](https://github.com/litlfred/folio-assistant/blob/main/skills/folio-core/code-lists.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/skills/folio-core/code-lists.md){: .fa-edit-source }
