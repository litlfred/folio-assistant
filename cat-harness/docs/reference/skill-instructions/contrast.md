...
{: .note }
> Generated from [`theming/contrast.md`](https://github.com/litlfred/folio-assistant/blob/main/theming/contrast.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/theming/contrast.md){: .fa-edit-source }
...
- [`theme-declaration`](declaration.md) — where a scrim is declared
- [`theme-generation`](generation.md) — why a theme can render with no rule at all
- [`theme-artefacts`](artefacts.md) — the surfaces this applies to, and where they differ
{% endraw %}
