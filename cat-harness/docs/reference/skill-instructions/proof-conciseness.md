...
{: .note }
> Generated from [`skills/folio-paper-adapter/proof-conciseness.md`](https://github.com/litlfred/folio-assistant/blob/main/skills/folio-paper-adapter/proof-conciseness.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/skills/folio-paper-adapter/proof-conciseness.md){: .fa-edit-source }
