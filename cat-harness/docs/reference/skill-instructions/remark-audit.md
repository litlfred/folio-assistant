...
{: .note }
> Generated from [`cat-harness/skills/folio-paper-adapter/remark-audit.md`](https://github.com/litlfred/folio-assistant/blob/main/cat-harness/skills/folio-paper-adapter/remark-audit.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/cat-harness/skills/folio-paper-adapter/remark-audit.md){: .fa-edit-source }
