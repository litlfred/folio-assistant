...
{: .note }
> Generated from [`.claude/skills/local/language-trap-agent-audit.md`](https://github.com/litlfred/folio-assistant/blob/main/.claude/skills/local/language-trap-agent-audit.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/.claude/skills/local/language-trap-agent-audit.md){: .fa-edit-source }
