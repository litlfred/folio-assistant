...
{: .note }
> Generated from [`skills/folio-core/create-sticky-note.md`](https://github.com/litlfred/folio-assistant/blob/main/skills/folio-core/create-sticky-note.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/skills/folio-core/create-sticky-note.md){: .fa-edit-source }
