...
{: .note }
> Generated from [`cat-harness/skills/folio-core/corpus-grep.md`](https://github.com/litlfred/folio-assistant/blob/main/cat-harness/skills/folio-core/corpus-grep.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/cat-harness/skills/folio-core/corpus-grep.md){: .fa-edit-source }
