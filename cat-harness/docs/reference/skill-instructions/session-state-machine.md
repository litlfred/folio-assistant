...
{: .note }
> Generated from [`skills/workflow/session-state-machine.md`](https://github.com/litlfred/folio-assistant/blob/main/skills/workflow/session-state-machine.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/skills/workflow/session-state-machine.md){: .fa-edit-source }
