...
{: .note }
> Generated from [`theming/artefacts.md`](https://github.com/litlfred/folio-assistant/blob/main/theming/artefacts.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/theming/artefacts.md){: .fa-edit-source }
...
- [`theming`](overview.md) — which stage owns your question
- [`theme-declaration`](declaration.md) — the rule these specialise
{% endraw %}
