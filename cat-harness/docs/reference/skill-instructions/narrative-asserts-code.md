...
{: .note }
> Generated from [`skills/folio-core/narrative-asserts-code.md`](https://github.com/litlfred/folio-assistant/blob/main/skills/folio-core/narrative-asserts-code.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/skills/folio-core/narrative-asserts-code.md){: .fa-edit-source }
