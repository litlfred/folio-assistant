...
{: .note }
> Generated from [`theming/generation.md`](https://github.com/litlfred/folio-assistant/blob/main/theming/generation.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/theming/generation.md){: .fa-edit-source }
...
- [`theme-declaration`](declaration.md) — where the values come from
- [`theme-contrast`](contrast.md) — what the generated ink must clear
- [`theme-artefacts`](artefacts.md) — the surfaces that consume this
{% endraw %}
