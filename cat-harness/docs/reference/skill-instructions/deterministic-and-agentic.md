...
{: .note }
> Generated from [`skills/workflow/deterministic-and-agentic.md`](https://github.com/litlfred/folio-assistant/blob/main/skills/workflow/deterministic-and-agentic.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/skills/workflow/deterministic-and-agentic.md){: .fa-edit-source }
