...
{: .note }
> Generated from [`skills/folio-core/skills-and-tools.md`](https://github.com/litlfred/folio-assistant/blob/main/skills/folio-core/skills-and-tools.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/skills/folio-core/skills-and-tools.md){: .fa-edit-source }
...
a filesystem and the instance's `<name>.json` can read all of it.
...
3. **Say a mechanism exists and where to find it** — never inline it. A Tool is
   ...
   `<name>.json` and read from the directory it names. Not a remembered
