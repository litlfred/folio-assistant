...
{: .note }
> Generated from [`theming/declaration.md`](https://github.com/litlfred/folio-assistant/blob/main/theming/declaration.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/theming/declaration.md){: .fa-edit-source }
...
- [`theme-art-intake`](intake.md) — the stage before: what may enter at all
- [`theme-generation`](generation.md) — the stage after: what is emitted from this
- [`theme-artefacts`](artefacts.md) — the per-surface specialisation
{% endraw %}
