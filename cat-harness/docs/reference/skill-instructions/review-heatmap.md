---
layout: default
title: 'Review heat map'
parent: Skill instructions
---

{: .note }
> Generated from [`skills/folio-core/review-heatmap.md`](https://github.com/litlfred/folio-assistant/blob/main/skills/folio-core/review-heatmap.md) — do not edit here.
>
> [✎ Edit this page's source](https://github.com/litlfred/folio-assistant/edit/main/skills/folio-core/review-heatmap.md){: .fa-edit-source }
...
| **Review coverage** | **not measured yet** | — | "every comment is resolved". Coverage needs a per-block reviewer VERDICT, which nothing records yet. The process now has the gate that needs it (`GW_Covered`, bean `en2d`), and recording verdicts is bean `px0t`. **Resolved comments are not approval**, so none is shown rather than a number built from them. |
