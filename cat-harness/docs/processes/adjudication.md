...
- **Called by:** [Content Change and Review](content-change-review.html), [Criterion adjudication](criterion-adjudication.html), [Ingestion subprocess — the L1 completeness gate](ingest-l1-completeness-gate.html), [Refresh materialized remote content](refresh-materialized.html), [Translation Workflow](translation-workflow.html)
- **Calls:** none
