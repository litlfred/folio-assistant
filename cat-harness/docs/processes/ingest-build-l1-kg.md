...
| **Write manifest.jsonld referencing it**<br>`Task_Manifest` | Ingestion Engine (agent, runs unattended) | [`document-intake`](../reference/skill-instructions/document-intake.html) | — |
...
| **Bind the folder name to the bibliography slug**<br>`Task_Bind` | Ingestion Engine (agent, runs unattended) | [`document-intake`](../reference/skill-instructions/document-intake.html) | — |
