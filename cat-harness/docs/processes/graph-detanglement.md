...
|---|---|---|---|
| **Brief the topic before&#10;touching anything**<br>`Task_Brief` | Authoring agent | [`opening-brief`](../reference/skill-instructions/opening-brief.html) | What am I doing and why is it worth doing; what do I already know, with each measurement's provenance; how do I plan to do it and WHAT WOULD FALSIFY THE APPROACH. A falsifier that never fires is decoration &#8212; this practice's own fired, took edges 5 to 12, and rewrote the plan. |
