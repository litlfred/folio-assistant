...
**5** of 12 step(s) carry no documentation — `activity-documented` lists them.

| step | lane | skill / sub-process | what it does |
|---|---|---|---|
| **Build the docs site Jekyll · TypeDoc · KG export**<br>`Task_Build` | CI/CD Pipeline | [`feature-staging`](../reference/skill-instructions/feature-staging.html) | — |
...
| **Comment the preview URL on the PR**<br>`Task_Comment` | CI/CD Pipeline | [`staging-review`](../reference/skill-instructions/staging-review.html) | — |
| **Derive the slug from the head ref**<br>`Task_Slug` | CI/CD Pipeline | [`feature-staging`](../reference/skill-instructions/feature-staging.html) | — |
...
| **Post the retention notice on the PR**<br>`Task_Notice` | CI/CD Pipeline | [`staging-review`](../reference/skill-instructions/staging-review.html) | — |
...
| **Remove it AND append `removed` — one commit**<br>`Task_RemoveDisp` | CI/CD Pipeline | [`deletion-requires-confirmation`](../reference/skill-instructions/deletion-requires-confirmation.html) | — |
