...
**73** diagram(s), **73** parsed, **0** that would not load.

| where | diagrams |
|---|---|
| `cat-harness/processes/` | 69 |
...
| [Alert the publication manager](publish-alert.html) | 4 | — |
| [Verify the export before it is deployed](publish-verification.html) | 1 | — |
...
**98** distinct skill(s) are named by an activity.
...
| `publish-verification` | `docs-site-publish.bpmn`, `publish-alert.bpmn`, `publish-verification.bpmn` |
...
Every one of the **73** diagrams has a rendered SVG.
