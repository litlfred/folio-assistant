...
**65** diagram(s), **65** parsed, **0** that would not load.

| where | diagrams |
|---|---|
| `cat-harness/processes/` | 61 |
...
| `methodology-adoption` | `options-analysis.bpmn`, `swot-analysis.bpmn`, `diig-investment-path.bpmn` |
...
Every one of the **65** diagrams has a rendered SVG.
