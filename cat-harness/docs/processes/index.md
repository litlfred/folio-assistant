...
**69** diagram(s), **69** parsed, **0** that would not load.

| where | diagrams |
|---|---|
| `cat-harness/processes/` | 65 |
...
Every one of the **69** diagrams has a rendered SVG.
