...
**1** of 17 step(s) carry no documentation — `activity-documented` lists them.
...
| **Revise the proposed change**<br>`Task_ReviseEdit` | Authoring agent (system) | [`content-author`](../reference/skill-instructions/content-author.html) | — |
