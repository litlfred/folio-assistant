...
<div class="fa-uml-views">
  <fieldset class="fa-uml-view-pick">
    ...
    <input type="radio" name="fa-uml-overview_folio_assistant_core_voices" id="fa-uml-overview_folio_assistant_core_voices-portrait" class="fa-uml-pick-portrait" checked><label for="fa-uml-overview_folio_assistant_core_voices-portrait">Portrait</label>
    <input type="radio" name="fa-uml-overview_folio_assistant_core_voices" id="fa-uml-overview_folio_assistant_core_voices-landscape" class="fa-uml-pick-landscape"><label for="fa-uml-overview_folio_assistant_core_voices-landscape">Landscape</label>
  </fieldset>
  <figure class="bpmn-figure fa-uml-portrait">
    <img src="{{ '/assets/img/uml/overview/folio-assistant-core/voices.svg' | relative_url }}" alt="UML class diagram of folio-assistant-core/voices: one package per named sub-graph, one class per node schema, with its data fields. Portrait layout.">
  </figure>
  <figure class="bpmn-figure fa-uml-landscape">
    <img src="{{ '/assets/img/uml/overview/folio-assistant-core/voices.landscape.svg' | relative_url }}" alt="UML class diagram of folio-assistant-core/voices: one package per named sub-graph, one class per node schema, with its data fields. Landscape layout.">
  </figure>
</div>
