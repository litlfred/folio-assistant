...
<figure class="bpmn-figure">
  <img src="{{ '/assets/img/uml/overview/detangle/detangle-results.svg' | relative_url }}" alt="UML class diagram of detangle/detangle-results: one package per named sub-graph, one class per node schema, with its data fields.">
</figure>
