...
<div class="fa-uml-views">
  <fieldset class="fa-uml-view-pick">
    ...
    <input type="radio" name="fa-uml-overview_bootstrap_processes" id="fa-uml-overview_bootstrap_processes-portrait" class="fa-uml-pick-portrait" checked><label for="fa-uml-overview_bootstrap_processes-portrait">Portrait</label>
    <input type="radio" name="fa-uml-overview_bootstrap_processes" id="fa-uml-overview_bootstrap_processes-landscape" class="fa-uml-pick-landscape"><label for="fa-uml-overview_bootstrap_processes-landscape">Landscape</label>
  </fieldset>
  <figure class="bpmn-figure fa-uml-portrait">
    <img src="{{ '/assets/img/uml/overview/bootstrap/processes.svg' | relative_url }}" alt="UML class diagram of bootstrap/processes: one package per named sub-graph, one class per node schema, with its data fields. Portrait layout.">
  </figure>
  <figure class="bpmn-figure fa-uml-landscape">
    <img src="{{ '/assets/img/uml/overview/bootstrap/processes.landscape.svg' | relative_url }}" alt="UML class diagram of bootstrap/processes: one package per named sub-graph, one class per node schema, with its data fields. Landscape layout.">
  </figure>
</div>
