...
<figure class="bpmn-figure">
  <img src="{{ '/assets/img/uml/overview/bootstrap/bootstrap-translations.svg' | relative_url }}" alt="UML class diagram of bootstrap/bootstrap-translations: one package per named sub-graph, one class per node schema, with its data fields.">
</figure>
