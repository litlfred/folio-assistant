...
<figure class="bpmn-figure">
  <img src="{{ '/assets/img/uml/overview/who-iris/who-iris-themes.svg' | relative_url }}" alt="UML class diagram of who-iris/who-iris-themes: one package per named sub-graph, one class per node schema, with its data fields.">
</figure>
