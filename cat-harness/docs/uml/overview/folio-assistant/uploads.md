...
<div class="fa-uml-views">
  <fieldset class="fa-uml-view-pick">
    ...
    <input type="radio" name="fa-uml-overview_folio_assistant_uploads" id="fa-uml-overview_folio_assistant_uploads-portrait" class="fa-uml-pick-portrait" checked><label for="fa-uml-overview_folio_assistant_uploads-portrait">Portrait</label>
    <input type="radio" name="fa-uml-overview_folio_assistant_uploads" id="fa-uml-overview_folio_assistant_uploads-landscape" class="fa-uml-pick-landscape"><label for="fa-uml-overview_folio_assistant_uploads-landscape">Landscape</label>
  </fieldset>
  <figure class="bpmn-figure fa-uml-portrait">
    <img src="{{ '/assets/img/uml/overview/folio-assistant/uploads.svg' | relative_url }}" alt="UML class diagram of folio-assistant/uploads: one package per named sub-graph, one class per node schema, with its data fields. Portrait layout.">
  </figure>
  <figure class="bpmn-figure fa-uml-landscape">
    <img src="{{ '/assets/img/uml/overview/folio-assistant/uploads.landscape.svg' | relative_url }}" alt="UML class diagram of folio-assistant/uploads: one package per named sub-graph, one class per node schema, with its data fields. Landscape layout.">
  </figure>
</div>
