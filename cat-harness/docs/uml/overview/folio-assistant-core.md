...
<figure class="bpmn-figure">
  <img src="{{ '/assets/img/uml/overview/folio-assistant-core.svg' | relative_url }}" alt="UML class diagram of folio-assistant-core: one package per named sub-graph, one class per node schema, with its data fields.">
</figure>
