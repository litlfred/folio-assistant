...
<figure class="bpmn-figure">
  <img src="{{ '/assets/img/uml/overview/bootstrap.svg' | relative_url }}" alt="UML class diagram of bootstrap: one package per named sub-graph, one class per node schema, with its data fields.">
</figure>
