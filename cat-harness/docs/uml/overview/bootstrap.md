...
| `bootstrap/schemas` | `bootstrap/schemas` | schemas | `schema: discussion.input.schema.json`; `schema: discussion.output.schema.json`; `schema: graph.schema.json`; `schema: model-registry.schema.json`; `schema: requirement.schema.json` | *not measured* | | | |
...
- [bootstrap/skills](bootstrap/skills.html)
...
- [bootstrap/swimlane-glossary](bootstrap/swimlane-glossary.html)
