...
| `bootstrap/schemas` | `bootstrap/schemas` | schemas | `schema: discussion.input.schema.json`; `schema: discussion.output.schema.json`; `schema: graph.schema.json`; `schema: model-registry.schema.json` | *not measured* | | | |
