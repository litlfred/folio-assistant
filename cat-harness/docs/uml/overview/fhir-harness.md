...
Generated by `cat-harness/scripts/gen-uml-overview.ts` — do not edit. Every named sub-graph the `fhir-harness` instance declares, one box each, with the node schema kinds found in it.
...
|---|---|---|---|---|---|---|---|
| `fhir-harness/fhir-ig-skills` | `fhir-harness/skills` | skills | skills: *could not determine* | *not measured* | | | |
