...
<figure class="bpmn-figure">
  <img src="{{ '/assets/img/uml/overview/fhir-harness.svg' | relative_url }}" alt="UML class diagram of fhir-harness: one package per named sub-graph, one class per node schema, with its data fields.">
</figure>
