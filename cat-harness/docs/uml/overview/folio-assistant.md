...
Generated by `cat-harness/scripts/gen-uml-overview.ts` — do not edit. Every named sub-graph the `folio-assistant` instance declares, one box each, with the node schema kinds found in it.
...
|---|---|---|---|---|---|---|---|
| `folio-assistant/uploads` | `uploads` | uploads | `ExtractionSchema` | *not measured* | | | |
...
- [folio-assistant/root-tools](folio-assistant/root-tools.html)
