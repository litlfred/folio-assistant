...
<figure class="bpmn-figure">
  <img src="{{ '/assets/img/uml/overview/folio-assistant.svg' | relative_url }}" alt="UML class diagram of folio-assistant: one package per named sub-graph, one class per node schema, with its data fields.">
</figure>
