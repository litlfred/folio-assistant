...
<figure class="bpmn-figure">
  <img src="{{ '/assets/img/uml/overview/cat-harness/detangle-schemas.svg' | relative_url }}" alt="UML class diagram of cat-harness/detangle-schemas: one package per named sub-graph, one class per node schema, with its data fields.">
</figure>
