...
<div class="fa-uml-views">
  <fieldset class="fa-uml-view-pick">
    ...
    <input type="radio" name="fa-uml-overview_cat_harness_bootstrap_tools_schemas" id="fa-uml-overview_cat_harness_bootstrap_tools_schemas-portrait" class="fa-uml-pick-portrait" checked><label for="fa-uml-overview_cat_harness_bootstrap_tools_schemas-portrait">Portrait</label>
    <input type="radio" name="fa-uml-overview_cat_harness_bootstrap_tools_schemas" id="fa-uml-overview_cat_harness_bootstrap_tools_schemas-landscape" class="fa-uml-pick-landscape"><label for="fa-uml-overview_cat_harness_bootstrap_tools_schemas-landscape">Landscape</label>
  </fieldset>
  <figure class="bpmn-figure fa-uml-portrait">
    <img src="{{ '/assets/img/uml/overview/cat-harness/bootstrap-tools-schemas.svg' | relative_url }}" alt="UML class diagram of cat-harness/bootstrap-tools-schemas: one package per named sub-graph, one class per node schema, with its data fields. Portrait layout.">
  </figure>
  <figure class="bpmn-figure fa-uml-landscape">
    <img src="{{ '/assets/img/uml/overview/cat-harness/bootstrap-tools-schemas.landscape.svg' | relative_url }}" alt="UML class diagram of cat-harness/bootstrap-tools-schemas: one package per named sub-graph, one class per node schema, with its data fields. Landscape layout.">
  </figure>
</div>
