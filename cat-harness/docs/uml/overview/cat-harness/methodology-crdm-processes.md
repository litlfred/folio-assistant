---
title: "UML — cat-harness/methodology-crdm-processes"
nav_exclude: true
---

# UML — cat-harness/methodology-crdm-processes

Generated by `cat-harness/scripts/gen-uml-overview.ts` — do not edit. The `methodology-crdm-processes` sub-graph of `cat-harness` (`cat-harness/methodologies/crdm/processes`), with every attribute read from its node schema.

**Sources (same model):** [PlantUML](https://github.com/litlfred/folio-assistant/blob/main/cat-harness/uml/overview/cat-harness/methodology-crdm-processes.puml) · [Mermaid](https://github.com/litlfred/folio-assistant/blob/main/cat-harness/uml/overview/cat-harness/methodology-crdm-processes.mmd)
