...
<div class="fa-uml-views">
  <fieldset class="fa-uml-view-pick">
    ...
    <input type="radio" name="fa-uml-overview_cat_harness_who_iris_skills" id="fa-uml-overview_cat_harness_who_iris_skills-portrait" class="fa-uml-pick-portrait" checked><label for="fa-uml-overview_cat_harness_who_iris_skills-portrait">Portrait</label>
    <input type="radio" name="fa-uml-overview_cat_harness_who_iris_skills" id="fa-uml-overview_cat_harness_who_iris_skills-landscape" class="fa-uml-pick-landscape"><label for="fa-uml-overview_cat_harness_who_iris_skills-landscape">Landscape</label>
  </fieldset>
  <figure class="bpmn-figure fa-uml-portrait">
    <img src="{{ '/assets/img/uml/overview/cat-harness/who-iris-skills.svg' | relative_url }}" alt="UML class diagram of cat-harness/who-iris-skills: one package per named sub-graph, one class per node schema, with its data fields. Portrait layout.">
  </figure>
  <figure class="bpmn-figure fa-uml-landscape">
    <img src="{{ '/assets/img/uml/overview/cat-harness/who-iris-skills.landscape.svg' | relative_url }}" alt="UML class diagram of cat-harness/who-iris-skills: one package per named sub-graph, one class per node schema, with its data fields. Landscape layout.">
  </figure>
</div>
