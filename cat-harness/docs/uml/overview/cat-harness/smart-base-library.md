...
<div class="fa-uml-views">
  <fieldset class="fa-uml-view-pick">
    ...
    <input type="radio" name="fa-uml-overview_cat_harness_smart_base_library" id="fa-uml-overview_cat_harness_smart_base_library-portrait" class="fa-uml-pick-portrait" checked><label for="fa-uml-overview_cat_harness_smart_base_library-portrait">Portrait</label>
    <input type="radio" name="fa-uml-overview_cat_harness_smart_base_library" id="fa-uml-overview_cat_harness_smart_base_library-landscape" class="fa-uml-pick-landscape"><label for="fa-uml-overview_cat_harness_smart_base_library-landscape">Landscape</label>
  </fieldset>
  <figure class="bpmn-figure fa-uml-portrait">
    <img src="{{ '/assets/img/uml/overview/cat-harness/smart-base-library.svg' | relative_url }}" alt="UML class diagram of cat-harness/smart-base-library: one package per named sub-graph, one class per node schema, with its data fields. Portrait layout.">
  </figure>
  <figure class="bpmn-figure fa-uml-landscape">
    <img src="{{ '/assets/img/uml/overview/cat-harness/smart-base-library.landscape.svg' | relative_url }}" alt="UML class diagram of cat-harness/smart-base-library: one package per named sub-graph, one class per node schema, with its data fields. Landscape layout.">
  </figure>
</div>
