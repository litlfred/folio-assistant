...
<figure class="bpmn-figure">
  <img src="{{ '/assets/img/uml/overview/cat-harness/docs.svg' | relative_url }}" alt="UML class diagram of cat-harness/docs: one package per named sub-graph, one class per node schema, with its data fields.">
</figure>
