...
Generated by `cat-harness/scripts/gen-uml-overview.ts` — do not edit. Every named sub-graph the `who-iris` instance declares, one box each, with the node schema kinds found in it.
...
<div class="fa-uml-views">
  <fieldset class="fa-uml-view-pick">
    ...
    <input type="radio" name="fa-uml-overview_who_iris" id="fa-uml-overview_who_iris-portrait" class="fa-uml-pick-portrait" checked><label for="fa-uml-overview_who_iris-portrait">Portrait</label>
    <input type="radio" name="fa-uml-overview_who_iris" id="fa-uml-overview_who_iris-landscape" class="fa-uml-pick-landscape"><label for="fa-uml-overview_who_iris-landscape">Landscape</label>
  </fieldset>
  <figure class="bpmn-figure fa-uml-portrait">
    <img src="{{ '/assets/img/uml/overview/who-iris.svg' | relative_url }}" alt="UML class diagram of who-iris: one package per named sub-graph, one class per node schema, with its data fields. Portrait layout.">
  </figure>
  <figure class="bpmn-figure fa-uml-landscape">
    <img src="{{ '/assets/img/uml/overview/who-iris.landscape.svg' | relative_url }}" alt="UML class diagram of who-iris: one package per named sub-graph, one class per node schema, with its data fields. Landscape layout.">
  </figure>
</div>

| sub-graph | directory | graph kinds | node schema | nodes | cohesion | in | out |
|---|---|---|---|---|---|---|---|
| `who-iris/library` | `who-iris/library` | library | `ImagesSidecarSchema`; `ts: VerdictFile`; `WithheldSchema` | *not measured* | | | |
...
| `who-iris/who-iris-uploads` | `who-iris/uploads` | uploads | `ExtractionSchema`; `untyped: written by scripts/library-graph.ts` | *not measured* | | | |
...
- [who-iris/who-iris-scripts](who-iris/who-iris-scripts.html)
...
classDiagram
  ...
  namespace who_iris__who_iris_uploads {
    ...
    class who_iris_who_iris_uploads_folio_intake_v1["folio-intake/v1"] {
      ...
      no schema declared, shape is whatever scripts/library-graph.ts writes
    }
  }
