...
| `cat-harness/qa` | `cat-harness/test/results` | qa | `KgQaReportSchema`; `BlockQaReport`; `TestRunSchema`; `ts: QaWitness`; `ts: QaResult`; `ts: TranslationBlockQaReport`; `untyped: written by scripts/gen-docs-pages.ts` | *not measured* | | | |
...
| `cat-harness/detangle-schemas` | `cat-harness/detangle/schemas` | schemas, cat-harness | schemas: *could not determine* | *not measured* | | | |
