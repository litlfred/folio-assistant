...
| `cat-harness/deploy` | `cat-harness/deploy` | code | code: *could not determine* | *not measured* | | | |
| `cat-harness/ui` | `cat-harness/ui` | code | code: *could not determine* | *not measured* | | | |
| `cat-harness/blueprint` | `cat-harness/blueprint` | code | code: *could not determine* | *not measured* | | | |
...
| `cat-harness/scenarios` | `cat-harness/scenarios` | scenarios | `RoleGraphSchema` | 2 | 0.00 | 0 | 260 |
| `cat-harness/policies` | `cat-harness/policies` | policies | `OdrlPolicySchema` | *not measured* | | | |
| `cat-harness/processes` | `cat-harness/processes` | processes | `ext: omg-bpmn-2.0` | 78 | 0.13 | 0 | 498 |
| `cat-harness/methodologies` | `cat-harness/methodologies` | methodology | methodology: *could not determine* | *not measured* | | | |
| `cat-harness/qa` | `cat-harness/test/results` | qa | `KgQaReportSchema`; `BlockQaReport`; `TestRunSchema`; `ts: QaWitness`; `ts: QaResult`; `ts: TranslationBlockQaReport`; `untyped: written by scripts/gen-docs-pages.ts`; `ts: DetangleSidecar`; `ViewerNavQaSchema` | *not measured* | | | |
...
| `cat-harness/library` | `cat-harness/library` | library | `ImagesSidecarSchema`; `ts: VerdictFile` | *not measured* | | | |
...
- [cat-harness/deploy](cat-harness/deploy.html)
- [cat-harness/ui](cat-harness/ui.html)
- [cat-harness/blueprint](cat-harness/blueprint.html)
...
classDiagram
  ...
  namespace cat_harness__deploy {
    class n_cat_harness_deploy_code["code: no node schema"] {
      <<could not determine>>
    }
  }
  namespace cat_harness__ui {
    class n_cat_harness_ui_code["code: no node schema"] {
      <<could not determine>>
    }
  }
  namespace cat_harness__blueprint {
    class n_cat_harness_blueprint_code["code: no node schema"] {
      <<could not determine>>
    }
  }
  ...
  cssClass "n_cat_harness_deploy_code" fa_uml_kind_code
  cssClass "n_cat_harness_deploy_code" fa_uml_undetermined
  cssClass "n_cat_harness_ui_code" fa_uml_kind_code
  cssClass "n_cat_harness_ui_code" fa_uml_undetermined
  cssClass "n_cat_harness_blueprint_code" fa_uml_kind_code
  cssClass "n_cat_harness_blueprint_code" fa_uml_undetermined
