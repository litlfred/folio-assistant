 ...
 * Usage:
 *
 *   bun run cat-harness/content/pipeline/codemod-val.ts <paper-or-chapter-dir>            # dry-run
 *   bun run cat-harness/content/pipeline/codemod-val.ts <paper-or-chapter-dir> --write    # apply
 *
