...
// ── Lean source lexing ──────────────────────────────────────────
//
// Moved to `lean-lexer.ts`: the grammar is core (see that module's header),
// while Atlas ingestion — what this file does with a parsed declaration — is
// the science layer's. Re-exported so existing importers are unaffected.
export { stripLeanComments, topLevelCut, splitDeclarations, type DeclSpan } from "./lean-lexer.js";
import { stripLeanComments, splitDeclarations } from "./lean-lexer.js";
