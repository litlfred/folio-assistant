...
export default webpage({
  ...
  nodes: [
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "skills/workflows/document-ingestion.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "https://github.com/litlfred/folio-assistant/blob/main/skills/workflows/document-ingestion.bpmn" },
        ],
        linkStyle: "button",
      },
      block: "the-pipeline",
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "skills/workflows/ingest-extract-structure.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "https://github.com/litlfred/folio-assistant/blob/main/skills/workflows/ingest-extract-structure.bpmn" },
        ],
        linkStyle: "button",
      },
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "skills/workflows/ingest-derive-content.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "https://github.com/litlfred/folio-assistant/blob/main/skills/workflows/ingest-derive-content.bpmn" },
        ],
        linkStyle: "button",
      },
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "skills/workflows/ingest-build-l1-kg.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "https://github.com/litlfred/folio-assistant/blob/main/skills/workflows/ingest-build-l1-kg.bpmn" },
        ],
        linkStyle: "button",
      },
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "skills/workflows/ingest-l1-completeness-gate.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "https://github.com/litlfred/folio-assistant/blob/main/skills/workflows/ingest-l1-completeness-gate.bpmn" },
        ],
        linkStyle: "button",
      },
