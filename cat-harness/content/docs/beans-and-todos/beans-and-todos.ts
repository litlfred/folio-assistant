...
export default webpage({
  ...
  nodes: [
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "skills/workflows/bean-lifecycle.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "https://github.com/litlfred/folio-assistant/blob/main/skills/workflows/bean-lifecycle.bpmn" },
        ],
        linkStyle: "button",
      },
