...
export default webpage({
  ...
  nodes: [
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "workflow-methodologies/crdm/workflows/crdm-requirements.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "https://github.com/litlfred/folio-assistant/blob/main/workflow-methodologies/crdm/workflows/crdm-requirements.bpmn" },
        ],
        linkStyle: "button",
      },
      block: "the-process",
