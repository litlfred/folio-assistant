...
export default webpage({
  ...
  nodes: [
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "methodologies/crdm/processes/crdm-requirements.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "https://github.com/litlfred/folio-assistant/blob/main/methodologies/crdm/processes/crdm-requirements.bpmn" },
        ],
        linkStyle: "button",
      },
      block: "the-process",
