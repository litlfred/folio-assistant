---
name: crdm-detect
title: CRDM — feature-request detection
origin: >
  CRDM (Collaborative Requirements Development Methodology), as adopted by this
  platform for stakeholder-facing requirements work.
applies-when: >
  ...
  requester is a content developer working through a BA, and the answer depends
  on what the folio says. NOT for a platform capability change raised by somebody
