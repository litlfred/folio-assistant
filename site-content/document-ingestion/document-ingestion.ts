...
export default webpage({
  ...
  nodes: [
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "docs/workflows/document-ingestion.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "workflows/document-ingestion.bpmn" },
        ],
        linkStyle: "button",
      },
      block: "the-pipeline",
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "docs/workflows/ingest-extract-structure.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "workflows/ingest-extract-structure.bpmn" },
        ],
        linkStyle: "button",
      },
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "docs/workflows/ingest-derive-content.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "workflows/ingest-derive-content.bpmn" },
        ],
        linkStyle: "button",
      },
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "docs/workflows/ingest-build-l1-kg.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "workflows/ingest-build-l1-kg.bpmn" },
        ],
        linkStyle: "button",
      },
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "docs/workflows/ingest-l1-completeness-gate.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "workflows/ingest-l1-completeness-gate.bpmn" },
        ],
        linkStyle: "button",
      },
