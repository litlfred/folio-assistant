...
description: >
  ...
  instrumented project routine. Reduce words to normal form with
  step-by-step logging, extract invariants, and emit witness JSON.
allowed-tools: Read Edit Bash Grep Glob Write Agent AskUserQuestion
---
