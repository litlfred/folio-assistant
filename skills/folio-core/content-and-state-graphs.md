---
name: content-and-state-graphs
description: >
  Every declared graph says what the instance IS or where something GOT TO.
  The definition, the two questions that settle a hard case, what a consumer
  may assume about each side, and why the classification is required rather
  than inferred.
---
