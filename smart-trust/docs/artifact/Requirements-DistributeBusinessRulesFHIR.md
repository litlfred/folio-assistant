---
title: "Distribute FHIR business rules — WHO SMART Trust artefact"
description: "Requirements/DistributeBusinessRulesFHIR in the WHO SMART Trust IG, with its canonical URL, published representations and DAK API sidecars."
nav_exclude: true
---
<style>
...
`Requirements/DistributeBusinessRulesFHIR`
...
| | |
|---|---|
| Canonical URL | `http://smart.who.int/trust/Requirements/DistributeBusinessRulesFHIR` |
