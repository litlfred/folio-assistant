---
title: "Receive business rules — WHO SMART Trust artefact"
description: "Requirements/ReceiveBusinessRules in the WHO SMART Trust IG, with its canonical URL, published representations and DAK API sidecars."
nav_exclude: true
---
<style>
...
`Requirements/ReceiveBusinessRules`
...
| | |
|---|---|
| Canonical URL | `http://smart.who.int/trust/Requirements/ReceiveBusinessRules` |
