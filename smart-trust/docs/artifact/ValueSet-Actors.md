...
| | |
|---|---|
| Canonical URL | `http://smart.who.int/trust/ValueSet/Actors` |
...
|---|---|---|
| JSON Schema | <https://worldhealthorganization.github.io/smart-trust/schemas/ValueSet-Actors.schema.json> | `fhir-artifact-index/dak/ValueSet-Actors.schema.json` |
| Displays | <https://worldhealthorganization.github.io/smart-trust/schemas/ValueSet-Actors.displays.json> | `fhir-artifact-index/dak/ValueSet-Actors.displays.json` |
| OpenAPI | <https://worldhealthorganization.github.io/smart-trust/schemas/ValueSet-Actors.openapi.json> | `fhir-artifact-index/dak/ValueSet-Actors.openapi.json` |
| JSON-LD | <https://worldhealthorganization.github.io/smart-trust/ValueSet-Actors.jsonld> | `fhir-artifact-index/dak/ValueSet-Actors.jsonld` |
