---
title: "Distribute PKI material as DID — WHO SMART Trust artefact"
description: "Requirements/DistributePKIMaterialDID in the WHO SMART Trust IG, with its canonical URL, published representations and DAK API sidecars."
nav_exclude: true
---
<style>
...
`Requirements/DistributePKIMaterialDID`
...
| | |
|---|---|
| Canonical URL | `http://smart.who.int/trust/Requirements/DistributePKIMaterialDID` |
