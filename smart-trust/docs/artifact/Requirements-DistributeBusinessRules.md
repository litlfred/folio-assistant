---
title: "Distribute business rules — WHO SMART Trust artefact"
description: "Requirements/DistributeBusinessRules in the WHO SMART Trust IG, with its canonical URL, published representations and DAK API sidecars."
nav_exclude: true
---
<style>
...
`Requirements/DistributeBusinessRules`
...
| | |
|---|---|
| Canonical URL | `http://smart.who.int/trust/Requirements/DistributeBusinessRules` |
