---
title: "Receive PKI material — WHO SMART Trust artefact"
description: "Requirements/ReceivePKUMaterial in the WHO SMART Trust IG, with its canonical URL, published representations and DAK API sidecars."
nav_exclude: true
---
<style>
...
`Requirements/ReceivePKUMaterial`
...
| | |
|---|---|
| Canonical URL | `http://smart.who.int/trust/Requirements/ReceivePKUMaterial` |
