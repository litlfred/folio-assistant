...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-overlay-root-resolution/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-overlay-root-resolution/assets/css/just-the-docs-' + theme + '.css');
}
