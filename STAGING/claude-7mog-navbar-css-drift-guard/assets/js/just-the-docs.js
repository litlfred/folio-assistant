...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-7mog-navbar-css-drift-guard/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-7mog-navbar-css-drift-guard/assets/css/just-the-docs-' + theme + '.css');
}
