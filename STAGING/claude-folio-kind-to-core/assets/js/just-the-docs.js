...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-folio-kind-to-core/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-folio-kind-to-core/assets/css/just-the-docs-' + theme + '.css');
}
