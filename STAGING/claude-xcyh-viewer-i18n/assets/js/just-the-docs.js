...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-xcyh-viewer-i18n/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-xcyh-viewer-i18n/assets/css/just-the-docs-' + theme + '.css');
}
