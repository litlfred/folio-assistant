...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-lhs-navbar-harness-folios-cqo9mu/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-lhs-navbar-harness-folios-cqo9mu/assets/css/just-the-docs-' + theme + '.css');
}
