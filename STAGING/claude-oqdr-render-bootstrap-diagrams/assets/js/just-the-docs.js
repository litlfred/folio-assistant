...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-oqdr-render-bootstrap-diagrams/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-oqdr-render-bootstrap-diagrams/assets/css/just-the-docs-' + theme + '.css');
}
