...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-sleepy-rubin-mr6kdu/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-sleepy-rubin-mr6kdu/assets/css/just-the-docs-' + theme + '.css');
}
