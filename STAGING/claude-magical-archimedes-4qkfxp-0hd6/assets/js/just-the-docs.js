...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-magical-archimedes-4qkfxp-0hd6/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-magical-archimedes-4qkfxp-0hd6/assets/css/just-the-docs-' + theme + '.css');
}
