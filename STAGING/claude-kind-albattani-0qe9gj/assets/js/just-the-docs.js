...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-kind-albattani-0qe9gj/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-kind-albattani-0qe9gj/assets/css/just-the-docs-' + theme + '.css');
}
