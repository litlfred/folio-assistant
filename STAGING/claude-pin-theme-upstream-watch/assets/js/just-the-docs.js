...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-pin-theme-upstream-watch/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-pin-theme-upstream-watch/assets/css/just-the-docs-' + theme + '.css');
}
