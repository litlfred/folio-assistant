...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-4kiw-box3/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-4kiw-box3/assets/css/just-the-docs-' + theme + '.css');
}
