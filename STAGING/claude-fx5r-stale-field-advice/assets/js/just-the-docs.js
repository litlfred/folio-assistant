...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-fx5r-stale-field-advice/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-fx5r-stale-field-advice/assets/css/just-the-docs-' + theme + '.css');
}
