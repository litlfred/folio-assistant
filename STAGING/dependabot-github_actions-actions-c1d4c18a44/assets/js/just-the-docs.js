...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/dependabot-github_actions-actions-c1d4c18a44/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/dependabot-github_actions-actions-c1d4c18a44/assets/css/just-the-docs-' + theme + '.css');
}
