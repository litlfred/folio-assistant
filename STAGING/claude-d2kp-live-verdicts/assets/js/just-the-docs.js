...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-d2kp-live-verdicts/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-d2kp-live-verdicts/assets/css/just-the-docs-' + theme + '.css');
}
