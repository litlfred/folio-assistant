...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-hand-check-beans-restating-skills/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-hand-check-beans-restating-skills/assets/css/just-the-docs-' + theme + '.css');
}
