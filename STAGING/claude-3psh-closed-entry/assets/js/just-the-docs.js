...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-3psh-closed-entry/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-3psh-closed-entry/assets/css/just-the-docs-' + theme + '.css');
}
