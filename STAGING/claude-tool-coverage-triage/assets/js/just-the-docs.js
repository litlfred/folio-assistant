...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-tool-coverage-triage/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-tool-coverage-triage/assets/css/just-the-docs-' + theme + '.css');
}
