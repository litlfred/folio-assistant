...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-sjic-one-navbar-renderer/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-sjic-one-navbar-renderer/assets/css/just-the-docs-' + theme + '.css');
}
