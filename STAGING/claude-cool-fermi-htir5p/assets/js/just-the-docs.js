...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-cool-fermi-htir5p/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-cool-fermi-htir5p/assets/css/just-the-docs-' + theme + '.css');
}
