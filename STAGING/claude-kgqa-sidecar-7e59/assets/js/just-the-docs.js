...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-kgqa-sidecar-7e59/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-kgqa-sidecar-7e59/assets/css/just-the-docs-' + theme + '.css');
}
