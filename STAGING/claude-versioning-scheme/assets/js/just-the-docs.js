...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-versioning-scheme/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-versioning-scheme/assets/css/just-the-docs-' + theme + '.css');
}
