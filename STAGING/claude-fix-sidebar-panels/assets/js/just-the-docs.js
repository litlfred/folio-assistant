...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-fix-sidebar-panels/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-fix-sidebar-panels/assets/css/just-the-docs-' + theme + '.css');
}
