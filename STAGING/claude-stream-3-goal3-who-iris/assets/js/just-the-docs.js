...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-stream-3-goal3-who-iris/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-stream-3-goal3-who-iris/assets/css/just-the-docs-' + theme + '.css');
}
