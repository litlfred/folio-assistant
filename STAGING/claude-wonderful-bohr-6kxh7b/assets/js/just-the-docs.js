...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-wonderful-bohr-6kxh7b/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-wonderful-bohr-6kxh7b/assets/css/just-the-docs-' + theme + '.css');
}
