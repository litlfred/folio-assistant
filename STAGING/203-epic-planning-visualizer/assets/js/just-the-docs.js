...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/203-epic-planning-visualizer/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/203-epic-planning-visualizer/assets/css/just-the-docs-' + theme + '.css');
}
