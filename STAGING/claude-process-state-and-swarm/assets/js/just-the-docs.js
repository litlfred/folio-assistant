...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-process-state-and-swarm/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-process-state-and-swarm/assets/css/just-the-docs-' + theme + '.css');
}
