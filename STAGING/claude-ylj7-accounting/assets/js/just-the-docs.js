...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-ylj7-accounting/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-ylj7-accounting/assets/css/just-the-docs-' + theme + '.css');
}
