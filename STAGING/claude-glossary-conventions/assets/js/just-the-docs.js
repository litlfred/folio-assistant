...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-glossary-conventions/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-glossary-conventions/assets/css/just-the-docs-' + theme + '.css');
}
