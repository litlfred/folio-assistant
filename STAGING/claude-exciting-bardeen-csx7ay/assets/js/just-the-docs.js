...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-exciting-bardeen-csx7ay/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-exciting-bardeen-csx7ay/assets/css/just-the-docs-' + theme + '.css');
}
