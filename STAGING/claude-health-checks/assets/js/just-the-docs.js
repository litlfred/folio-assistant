...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-health-checks/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-health-checks/assets/css/just-the-docs-' + theme + '.css');
}
