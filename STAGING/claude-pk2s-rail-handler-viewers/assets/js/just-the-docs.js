...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-pk2s-rail-handler-viewers/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-pk2s-rail-handler-viewers/assets/css/just-the-docs-' + theme + '.css');
}
