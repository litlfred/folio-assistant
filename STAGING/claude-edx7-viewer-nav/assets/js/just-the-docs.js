...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-edx7-viewer-nav/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-edx7-viewer-nav/assets/css/just-the-docs-' + theme + '.css');
}
