...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-yag0-false-finding/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-yag0-false-finding/assets/css/just-the-docs-' + theme + '.css');
}
