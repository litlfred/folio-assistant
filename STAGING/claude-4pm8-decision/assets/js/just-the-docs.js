...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-4pm8-decision/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-4pm8-decision/assets/css/just-the-docs-' + theme + '.css');
}
