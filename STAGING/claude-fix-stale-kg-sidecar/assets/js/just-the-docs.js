...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-fix-stale-kg-sidecar/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-fix-stale-kg-sidecar/assets/css/just-the-docs-' + theme + '.css');
}
