...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-j66n-theme-gateway/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-j66n-theme-gateway/assets/css/just-the-docs-' + theme + '.css');
}
