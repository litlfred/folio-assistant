...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-oe98-generator-prefix/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-oe98-generator-prefix/assets/css/just-the-docs-' + theme + '.css');
}
