...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-oi1y-api-nav-2/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-oi1y-api-nav-2/assets/css/just-the-docs-' + theme + '.css');
}
