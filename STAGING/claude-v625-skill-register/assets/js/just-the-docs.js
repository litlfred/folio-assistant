...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-v625-skill-register/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-v625-skill-register/assets/css/just-the-docs-' + theme + '.css');
}
