...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-ce65-actor-kinds/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-ce65-actor-kinds/assets/css/just-the-docs-' + theme + '.css');
}
