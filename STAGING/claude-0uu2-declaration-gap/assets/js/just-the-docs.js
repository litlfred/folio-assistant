...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-0uu2-declaration-gap/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-0uu2-declaration-gap/assets/css/just-the-docs-' + theme + '.css');
}
