...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-smart-base-avatar/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-smart-base-avatar/assets/css/just-the-docs-' + theme + '.css');
}
