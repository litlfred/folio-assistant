...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-eager-thompson-3bb3kq/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-eager-thompson-3bb3kq/assets/css/just-the-docs-' + theme + '.css');
}
