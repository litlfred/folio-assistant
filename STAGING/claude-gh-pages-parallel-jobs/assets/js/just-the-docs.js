...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-gh-pages-parallel-jobs/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-gh-pages-parallel-jobs/assets/css/just-the-docs-' + theme + '.css');
}
