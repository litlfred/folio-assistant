...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/dependabot-npm_and_yarn-cat-harness-schemas-block-qa-schema-zod-4.6.5/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/dependabot-npm_and_yarn-cat-harness-schemas-block-qa-schema-zod-4.6.5/assets/css/just-the-docs-' + theme + '.css');
}
