...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-9x9r-head-has-run-any-run/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-9x9r-head-has-run-any-run/assets/css/just-the-docs-' + theme + '.css');
}
