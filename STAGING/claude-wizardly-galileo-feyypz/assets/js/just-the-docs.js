...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-wizardly-galileo-feyypz/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-wizardly-galileo-feyypz/assets/css/just-the-docs-' + theme + '.css');
}
