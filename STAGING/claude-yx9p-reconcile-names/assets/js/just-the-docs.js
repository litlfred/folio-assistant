...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-yx9p-reconcile-names/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-yx9p-reconcile-names/assets/css/just-the-docs-' + theme + '.css');
}
