...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-u9r9-typedoc-path/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-u9r9-typedoc-path/assets/css/just-the-docs-' + theme + '.css');
}
