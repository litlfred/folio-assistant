...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-charming-curie-n04agq/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-charming-curie-n04agq/assets/css/just-the-docs-' + theme + '.css');
}
