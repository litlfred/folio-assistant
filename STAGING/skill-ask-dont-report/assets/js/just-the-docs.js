...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/skill-ask-dont-report/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/skill-ask-dont-report/assets/css/just-the-docs-' + theme + '.css');
}
