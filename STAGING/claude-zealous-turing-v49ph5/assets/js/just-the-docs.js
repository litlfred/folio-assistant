...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-zealous-turing-v49ph5/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-zealous-turing-v49ph5/assets/css/just-the-docs-' + theme + '.css');
}
