...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-fx5r-check-by-hand/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-fx5r-check-by-hand/assets/css/just-the-docs-' + theme + '.css');
}
