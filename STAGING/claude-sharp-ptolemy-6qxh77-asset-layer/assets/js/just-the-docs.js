...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-sharp-ptolemy-6qxh77-asset-layer/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-sharp-ptolemy-6qxh77-asset-layer/assets/css/just-the-docs-' + theme + '.css');
}
