...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-oe98-schema-docs-prefix/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-oe98-schema-docs-prefix/assets/css/just-the-docs-' + theme + '.css');
}
