...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-cool-rubin-fgb5gh/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-cool-rubin-fgb5gh/assets/css/just-the-docs-' + theme + '.css');
}
