...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-bean-8h42-layout/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-bean-8h42-layout/assets/css/just-the-docs-' + theme + '.css');
}
