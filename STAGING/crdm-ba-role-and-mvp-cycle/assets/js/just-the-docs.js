...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/crdm-ba-role-and-mvp-cycle/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/crdm-ba-role-and-mvp-cycle/assets/css/just-the-docs-' + theme + '.css');
}
