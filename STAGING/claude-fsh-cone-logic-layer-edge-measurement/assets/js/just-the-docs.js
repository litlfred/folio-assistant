...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-fsh-cone-logic-layer-edge-measurement/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-fsh-cone-logic-layer-edge-measurement/assets/css/just-the-docs-' + theme + '.css');
}
