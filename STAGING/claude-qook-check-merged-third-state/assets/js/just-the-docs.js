...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-qook-check-merged-third-state/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-qook-check-merged-third-state/assets/css/just-the-docs-' + theme + '.css');
}
