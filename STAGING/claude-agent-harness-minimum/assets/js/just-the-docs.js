...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-agent-harness-minimum/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-agent-harness-minimum/assets/css/just-the-docs-' + theme + '.css');
}
