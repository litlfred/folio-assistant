...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-stream-2-goal2-surface/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-stream-2-goal2-surface/assets/css/just-the-docs-' + theme + '.css');
}
