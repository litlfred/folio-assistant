...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-proposals-to-docs/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-proposals-to-docs/assets/css/just-the-docs-' + theme + '.css');
}
