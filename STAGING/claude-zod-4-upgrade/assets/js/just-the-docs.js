...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-zod-4-upgrade/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-zod-4-upgrade/assets/css/just-the-docs-' + theme + '.css');
}
