...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-windows-bat-wrappers-2026-09-18/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-windows-bat-wrappers-2026-09-18/assets/css/just-the-docs-' + theme + '.css');
}
