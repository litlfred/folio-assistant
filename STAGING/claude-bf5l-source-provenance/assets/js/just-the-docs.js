...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-bf5l-source-provenance/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-bf5l-source-provenance/assets/css/just-the-docs-' + theme + '.css');
}
