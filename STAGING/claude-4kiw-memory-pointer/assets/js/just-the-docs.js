...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-4kiw-memory-pointer/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-4kiw-memory-pointer/assets/css/just-the-docs-' + theme + '.css');
}
