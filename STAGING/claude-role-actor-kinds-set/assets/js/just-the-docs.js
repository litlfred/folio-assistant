...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-role-actor-kinds-set/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-role-actor-kinds-set/assets/css/just-the-docs-' + theme + '.css');
}
