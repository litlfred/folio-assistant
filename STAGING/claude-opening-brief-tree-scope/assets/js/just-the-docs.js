...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-opening-brief-tree-scope/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-opening-brief-tree-scope/assets/css/just-the-docs-' + theme + '.css');
}
