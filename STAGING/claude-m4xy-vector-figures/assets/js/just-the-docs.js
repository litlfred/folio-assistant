...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-m4xy-vector-figures/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-m4xy-vector-figures/assets/css/just-the-docs-' + theme + '.css');
}
