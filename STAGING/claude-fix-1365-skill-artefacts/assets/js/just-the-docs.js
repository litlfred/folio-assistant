...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-fix-1365-skill-artefacts/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-fix-1365-skill-artefacts/assets/css/just-the-docs-' + theme + '.css');
}
