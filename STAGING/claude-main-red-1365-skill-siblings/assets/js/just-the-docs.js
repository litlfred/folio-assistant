...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-main-red-1365-skill-siblings/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-main-red-1365-skill-siblings/assets/css/just-the-docs-' + theme + '.css');
}
