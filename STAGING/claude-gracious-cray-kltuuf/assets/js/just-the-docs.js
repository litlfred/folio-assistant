...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-gracious-cray-kltuuf/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-gracious-cray-kltuuf/assets/css/just-the-docs-' + theme + '.css');
}
