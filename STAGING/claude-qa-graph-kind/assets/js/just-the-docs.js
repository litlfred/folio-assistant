...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-qa-graph-kind/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-qa-graph-kind/assets/css/just-the-docs-' + theme + '.css');
}
