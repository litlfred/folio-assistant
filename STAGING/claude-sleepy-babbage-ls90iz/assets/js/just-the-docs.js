...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-sleepy-babbage-ls90iz/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-sleepy-babbage-ls90iz/assets/css/just-the-docs-' + theme + '.css');
}
