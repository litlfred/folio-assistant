...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-rptk-language-bar-contrast/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-rptk-language-bar-contrast/assets/css/just-the-docs-' + theme + '.css');
}
