...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/dependabot-bundler-cat-harness-docs-bundler-3567caad51/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/dependabot-bundler-cat-harness-docs-bundler-3567caad51/assets/css/just-the-docs-' + theme + '.css');
}
