...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-0uu2-declare-deploy-tools/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-0uu2-declare-deploy-tools/assets/css/just-the-docs-' + theme + '.css');
}
