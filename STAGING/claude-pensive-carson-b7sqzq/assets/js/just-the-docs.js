...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-pensive-carson-b7sqzq/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-pensive-carson-b7sqzq/assets/css/just-the-docs-' + theme + '.css');
}
