...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-lvw0-locale-jsonld-publish/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-lvw0-locale-jsonld-publish/assets/css/just-the-docs-' + theme + '.css');
}
