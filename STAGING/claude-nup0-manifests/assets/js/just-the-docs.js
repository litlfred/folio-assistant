...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-nup0-manifests/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-nup0-manifests/assets/css/just-the-docs-' + theme + '.css');
}
