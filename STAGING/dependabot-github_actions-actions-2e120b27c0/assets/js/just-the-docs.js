...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/dependabot-github_actions-actions-2e120b27c0/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/dependabot-github_actions-actions-2e120b27c0/assets/css/just-the-docs-' + theme + '.css');
}
