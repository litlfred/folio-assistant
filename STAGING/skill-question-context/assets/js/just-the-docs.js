...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/skill-question-context/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/skill-question-context/assets/css/just-the-docs-' + theme + '.css');
}
