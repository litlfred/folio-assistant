...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-zhg2-reference-direction/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-zhg2-reference-direction/assets/css/just-the-docs-' + theme + '.css');
}
