...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-740-windows-bootstrap/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-740-windows-bootstrap/assets/css/just-the-docs-' + theme + '.css');
}
