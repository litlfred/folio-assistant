...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-glossary-pot-paper/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-glossary-pot-paper/assets/css/just-the-docs-' + theme + '.css');
}
