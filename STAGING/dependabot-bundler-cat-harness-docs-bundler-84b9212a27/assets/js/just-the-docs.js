...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/dependabot-bundler-cat-harness-docs-bundler-84b9212a27/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/dependabot-bundler-cat-harness-docs-bundler-84b9212a27/assets/css/just-the-docs-' + theme + '.css');
}
