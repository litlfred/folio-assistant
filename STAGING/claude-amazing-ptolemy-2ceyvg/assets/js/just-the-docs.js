...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-amazing-ptolemy-2ceyvg/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-amazing-ptolemy-2ceyvg/assets/css/just-the-docs-' + theme + '.css');
}
