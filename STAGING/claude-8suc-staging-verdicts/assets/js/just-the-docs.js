...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-8suc-staging-verdicts/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-8suc-staging-verdicts/assets/css/just-the-docs-' + theme + '.css');
}
