...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-unify-text-source/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-unify-text-source/assets/css/just-the-docs-' + theme + '.css');
}
