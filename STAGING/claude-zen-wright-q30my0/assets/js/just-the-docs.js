...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-zen-wright-q30my0/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-zen-wright-q30my0/assets/css/just-the-docs-' + theme + '.css');
}
