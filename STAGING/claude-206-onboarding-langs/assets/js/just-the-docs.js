...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-206-onboarding-langs/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-206-onboarding-langs/assets/css/just-the-docs-' + theme + '.css');
}
