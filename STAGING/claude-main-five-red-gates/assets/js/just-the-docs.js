...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-main-five-red-gates/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-main-five-red-gates/assets/css/just-the-docs-' + theme + '.css');
}
