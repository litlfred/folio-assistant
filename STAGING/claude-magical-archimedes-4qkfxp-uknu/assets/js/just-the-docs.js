...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-magical-archimedes-4qkfxp-uknu/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-magical-archimedes-4qkfxp-uknu/assets/css/just-the-docs-' + theme + '.css');
}
