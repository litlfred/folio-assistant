...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-elegant-albattani-0byaig/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-elegant-albattani-0byaig/assets/css/just-the-docs-' + theme + '.css');
}
