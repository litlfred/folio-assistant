...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-cflw-kg-qa-manifest/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-cflw-kg-qa-manifest/assets/css/just-the-docs-' + theme + '.css');
}
