...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-salvage-1340-1040/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-salvage-1340-1040/assets/css/just-the-docs-' + theme + '.css');
}
