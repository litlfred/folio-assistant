...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-stream-4-instruments/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-stream-4-instruments/assets/css/just-the-docs-' + theme + '.css');
}
