...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-glossary-split-actors/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-glossary-split-actors/assets/css/just-the-docs-' + theme + '.css');
}
