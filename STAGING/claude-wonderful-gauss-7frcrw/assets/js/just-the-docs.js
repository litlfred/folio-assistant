...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-wonderful-gauss-7frcrw/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-wonderful-gauss-7frcrw/assets/css/just-the-docs-' + theme + '.css');
}
