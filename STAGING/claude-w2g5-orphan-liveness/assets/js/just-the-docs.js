...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-w2g5-orphan-liveness/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-w2g5-orphan-liveness/assets/css/just-the-docs-' + theme + '.css');
}
