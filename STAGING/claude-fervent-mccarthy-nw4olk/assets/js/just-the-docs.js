...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-fervent-mccarthy-nw4olk/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-fervent-mccarthy-nw4olk/assets/css/just-the-docs-' + theme + '.css');
}
