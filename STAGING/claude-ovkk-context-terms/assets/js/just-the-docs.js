...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-ovkk-context-terms/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-ovkk-context-terms/assets/css/just-the-docs-' + theme + '.css');
}
