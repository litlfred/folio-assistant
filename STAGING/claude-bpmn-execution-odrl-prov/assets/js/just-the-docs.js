...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-bpmn-execution-odrl-prov/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-bpmn-execution-odrl-prov/assets/css/just-the-docs-' + theme + '.css');
}
