...
function initSearch() {
  ...
  request.open('GET', '/folio-assistant/STAGING/claude-brave-hypatia-r820sf/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/folio-assistant/STAGING/claude-brave-hypatia-r820sf/assets/css/just-the-docs-' + theme + '.css');
}
