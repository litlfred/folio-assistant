...
export default webpage({
  ...
  nodes: [
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "docs/workflows/editing-hci-validation.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "workflows/editing-hci-validation.bpmn" },
        ],
        linkStyle: "button",
      },
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "docs/workflows/draft-to-publication.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "workflows/draft-to-publication.bpmn" },
        ],
        linkStyle: "button",
      },
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "docs/workflows/content-lifecycle.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "workflows/content-lifecycle.bpmn" },
        ],
        linkStyle: "button",
      },
