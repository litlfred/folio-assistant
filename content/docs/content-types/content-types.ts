  ...
  nodes: [
    ...
    },
    {
      ...
      asset: {
        ...
        sourceLinks: [
          { text: "BPMN 2.0 source", href: "workflows/content-lifecycle.bpmn" },
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "docs/workflows/l2-dak-authoring.bpmn",
        ...
        sourceLinks: [
          { text: "BPMN 2.0 source", href: "workflows/l2-dak-authoring.bpmn" },
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "docs/workflows/l3-fhir-pipeline.bpmn",
        ...
        sourceLinks: [
          { text: "BPMN 2.0 source", href: "workflows/l3-fhir-pipeline.bpmn" },
