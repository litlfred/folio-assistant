...
export default webpage({
  ...
  nodes: [
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "skills/workflows/evidence-retrieval.bpmn",
        ...
        sourceLinks: [
          { text: "BPMN 2.0 source", href: "https://github.com/litlfred/folio-assistant/blob/main/skills/workflows/evidence-retrieval.bpmn" },
