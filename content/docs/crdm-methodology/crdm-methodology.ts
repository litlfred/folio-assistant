...
export default webpage({
  ...
  nodes: [
    ...
    },
    {
      ...
      asset: {
        kind: "bpmn",
        source: "skills/workflows/crdm-requirements.bpmn",
        ...
        sourceLinks: [
          { text: "Open the BPMN source", href: "https://github.com/litlfred/folio-assistant/blob/main/skills/workflows/crdm-requirements.bpmn" },
        ],
        linkStyle: "button",
      },
      block: "the-process",
