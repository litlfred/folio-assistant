...
// Same literal as `kg-audit.ts`: the actor registry is agent-tool
// configuration under `.claude/`, not a declared knowledge-graph directory,
// so there is no declaration to read it from.
