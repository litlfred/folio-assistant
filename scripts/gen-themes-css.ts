...
export const THEMES_CSS_PATH = join("docs", "folio-assistant", "assets", "css", "themes.css");
...
if (import.meta.main) {
  ...
  const path = join(process.cwd(), THEMES_CSS_PATH);
  ...
  console.log(`wrote ${THEMES_CSS_PATH} (${THEMES.length} themes, default ${DEFAULT_THEME_ID})`);
}
