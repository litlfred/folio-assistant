...
depository (library, place)

deprecate (disapprove)

depreciate (belittle)

dermatotropic (not dermotropic)
...
disinsection (not disinsectization)
...
disease; avoid dracontiasis)

draft, draftsman (of texts)

draught, draughtsman (of drawings)

drier (comp. adj. & machine)

drinking-water (but International
...
enquire (seek information)

enrol, enrolled, enrolment

en route

ensure (make sure; compare insure)

enterocolitis

enzyme-linked immunosorbent
assay (ELISA) (not ...immuno-
absorbent; not Elisa)
...
excreta (treat as plural)

Executive Director of UNICEF (no
hyphen)
