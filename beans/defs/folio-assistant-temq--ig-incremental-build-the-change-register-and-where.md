...
its place, author it as BPMN under `docs/workflows/` (this repo's rule), generate the
...
- `docs/workflows/ig-incremental-build.bpmn` (+ generated SVG): the incremental build
