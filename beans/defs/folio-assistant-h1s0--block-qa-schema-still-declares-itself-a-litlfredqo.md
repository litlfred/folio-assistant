...
updated_at: 2026-09-19T00:10:05Z
---
...
## Todo
- [ ] `package.json`: repository url + directory, homepage, bugs, description
- [ ] `pyproject.toml`: description, authors, keywords
- [ ] README description line, if it names QOU
- [ ] check whether either package is actually published anywhere before
